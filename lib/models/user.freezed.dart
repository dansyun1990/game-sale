...
abstract class $UserCopyWith<$Res> {
  ...
  $Res call(
      {String? id, String email, String userName, List<String> favorites});
}
...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, userName: $userName, favorites: $favorites)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      required String email,
      required String userName,
      required List<String> favorites}) = _$_User;
